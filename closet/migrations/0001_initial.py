...
>>>>>>> c9343bbd1fa87eb52bdce07d56dd464a1130562f
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('outfit', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='analysis_result', to='closet.outfit')),
            ],
        ),
        migrations.CreateModel(
