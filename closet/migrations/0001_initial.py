    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outfit', models.ForeignKey(blank=True, null=True, on_delete=models.SET_NULL, related_name='recommendations', to='closet.outfit')),
                ('user', models.ForeignKey(on_delete=models.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
